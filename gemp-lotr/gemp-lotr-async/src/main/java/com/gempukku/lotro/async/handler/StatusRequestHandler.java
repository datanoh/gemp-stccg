...
public class StatusRequestHandler extends LotroServerRequestHandler implements UriRequestHandler {
    ...
    public void handleRequest(String uri, HttpRequest request, Map<Type, Object> context, ResponseWriter responseWriter, String remoteIp) throws Exception {
        if (uri.equals("") && request.method() == HttpMethod.GET) {
            ...
            String sb = "Tables count: " + _hallServer.getTablesCount() + "<br>Players in hall: " + _chatServer.getChatRoom("Game Hall").getUsersInRoom(false).size() +
                    "<br>Games played in last 24 hours: " + _gameHistoryService.getGamesPlayedCount(yesterday, today) +
                    "<br>Active players in last week: " + _gameHistoryService.getActivePlayersCount(lastWeek, today);
